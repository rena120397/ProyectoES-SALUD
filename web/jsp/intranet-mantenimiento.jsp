...
<%
    ...
    listaUsuarios = (ArrayList) request.getAttribute("alUsuarios");
%>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2>Bienvenido Usuario: <%=bUsuario.getNOMBRE()%></h2><hr>
            <h4>Tabla Operadores</h4>
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        %>                    
                        <tr>
                            <td><%=listaUsuarios.get(i).getID_USU()%></td>
                            <td><%=listaUsuarios.get(i).getNOMBRE()%></td>
                            <td><%=listaUsuarios.get(i).getCONTRA()%></td>
                            <td><%=listaUsuarios.get(i).getID_PERFIL()%></td>
                        </tr>                        
                ...
                <a href="Intranet" class=" btn btn-danger">Regresar a página principal</a>
            </div><hr>
            <form method="POST" action="Mantenimiento">
                <div class="form-group">
                    <label for="nombre">Id_Usu</label>
                    <input type="text" name="TXT_ID_USU" class="form-control" placeholder="Ingrese ID_USU a a eliminar">
                </div>
                ...
                <form method="POST" action="Mantenimiento">
                    ...
                    <button type="submit" class="btn btn-danger text-center">REGISTRAR NUEVO</button>
                    <br>
                    </form>
