...
<body>
  ...
  <ul class="nav nav-tabs flex-row-reverse" role="tablist">
    ...
    <li class="nav-item">
      <a class="nav-link font-weight-bold active text-gray" data-toggle="tab" href="#intranet">Intranet</a>
    </li>
    <li class="nav-item">
      <a class="nav-link font-weight-bold text-gray" data-toggle="tab" href="#home">Afiliados</a>
    </li>
  </ul>
  ...
  <!-- Tab panes -->
    <div class="tab-content navi">
        ...
        <div id="intranet" class="container tab-pane active"><br>
